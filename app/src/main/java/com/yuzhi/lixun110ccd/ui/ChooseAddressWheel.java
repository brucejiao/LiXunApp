...
import com.yuzhi.lixun110ccd.ui.wheelview.MyOnWheelChangedListener;
import com.yuzhi.lixun110ccd.ui.wheelview.MyWheelView;
import com.yuzhi.lixun110ccd.ui.wheelview.adapter.AreaWheelAdapter;
import com.yuzhi.lixun110ccd.ui.wheelview.adapter.CityWheelAdapter;
import com.yuzhi.lixun110ccd.ui.wheelview.adapter.ProvinceWheelAdapter;
...
public class ChooseAddressWheel implements MyOnWheelChangedListener {
    ...
    private void initPopupWindow() {
        popupWindow = new PopupWindow(parentView, WindowManager.LayoutParams.MATCH_PARENT, (int) (CommUtil.getScreenHeight(context) * (2.0 / 5)));
