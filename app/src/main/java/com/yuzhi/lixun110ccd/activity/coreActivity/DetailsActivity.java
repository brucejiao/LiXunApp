...
public class DetailsActivity extends AppCompatActivity {
    ...
    com.yuzhi.lixun110ccd.utils.SharePreferenceUtil1 share;
    com.yuzhi.lixun110ccd.ui.AddContentDialog mDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        share = new com.yuzhi.lixun110ccd.utils.SharePreferenceUtil1(mContext, "lx_data", 0);
        initUI();
        initData();
    }
    ...
    public void reportClick(View view){
        com.yuzhi.lixun110ccd.ui.UIHelper.mineComplainPage(mContext);
    }
...
//        CommUtil.showAlert(publistID+"---"+secondMenu,mContext);
        ...
        progress = com.yuzhi.lixun110ccd.utils.CommUtil.showProgress(mContext, "正在加载数据，请稍候...");
        HashMap<String, String> params = new HashMap<>();
        params.put("publishid", publistID);

        com.yuzhi.lixun110ccd.http.HttpClient.get(com.yuzhi.lixun110ccd.http.Caller.DETAILS_ISSUE_INFOS, params, new com.yuzhi.lixun110ccd.http.HttpResponseHandler() {
            @Override
            public void onSuccess(com.yuzhi.lixun110ccd.http.RestApiResponse response) {
                String result = response.getResult();
                String message = response.getMessage();
                String data = response.getData();

                if (!com.yuzhi.lixun110ccd.utils.CommUtil.isNullOrBlank(result) && result.equals(RESUTL_TRUE)) {
                    com.yuzhi.lixun110ccd.model.LXFind.FindListBean findList = JSON.parseObject(data, com.yuzhi.lixun110ccd.model.LXFind.FindListBean.class);

                    com.yuzhi.lixun110ccd.model.LXFindServerBean lxFindServerBean = new com.yuzhi.lixun110ccd.model.LXFindServerBean();
                    //接口数据
...
//                        lxFindServerBean.setMessageNum(visitCount);
                    ...
                    List<com.yuzhi.lixun110ccd.model.LXFind.FindListPicList> findListPicLists = parseArray(pictueeList, com.yuzhi.lixun110ccd.model.LXFind.FindListPicList.class);
...
//                                .resize(LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT)
                    ...
                    //数据刷新到界面上
                    //头像
                    Picasso.with(mContext).load(headerImgPath).resize(com.yuzhi.lixun110ccd.utils.DeviceUtil.dp2px(mContext, 50), com.yuzhi.lixun110ccd.utils.DeviceUtil.dp2px(mContext, 50)).placeholder(R.drawable.default_image).into(mDetailsRoundHeader);
                    mDetailsUserName.setText(userName);
                    mDetailsPrice.setText("¥" + subMoneyZero(money,1) + "元");
                    mDetailsAddress.setText(address);
                    if (!com.yuzhi.lixun110ccd.utils.CommUtil.isNullOrBlank(secondMenu)) {
...
//        params.put("lastnumber", publistID);//最后一条记录的ID
        ...
        com.yuzhi.lixun110ccd.http.HttpClient.get(com.yuzhi.lixun110ccd.http.Caller.DETAILS_COMMENT_LIST, params, new com.yuzhi.lixun110ccd.http.HttpResponseHandler() {
            @Override
            public void onSuccess(com.yuzhi.lixun110ccd.http.RestApiResponse response) {
                String result = response.getResult();
                String message = response.getMessage();
                String data = response.getData();
                ArrayList<com.yuzhi.lixun110ccd.model.DetailsComment.CommentBean> commentBeanList = new ArrayList<com.yuzhi.lixun110ccd.model.DetailsComment.CommentBean>();
                if (!com.yuzhi.lixun110ccd.utils.CommUtil.isNullOrBlank(result) && result.equals(RESUTL_TRUE)) {
                    List<com.yuzhi.lixun110ccd.model.DetailsComment.CommentBean> findList = JSON.parseArray(data, com.yuzhi.lixun110ccd.model.DetailsComment.CommentBean.class);
                    final int findListNum = findList.size();
                    mDetailsPeoNum.setText("评论(" + findListNum + ")");
                    for (int index = 0; index < findListNum; index++) {
                        com.yuzhi.lixun110ccd.model.DetailsComment.CommentBean commentBean = new com.yuzhi.lixun110ccd.model.DetailsComment.CommentBean();
                    ...
                    com.yuzhi.lixun110ccd.ui.FragmentAdapter.ContentItemapter contentItemapter = new com.yuzhi.lixun110ccd.ui.FragmentAdapter.ContentItemapter(mContext, commentBeanList);
                    mDetailsReviewLV.setAdapter(contentItemapter);
                    com.yuzhi.lixun110ccd.utils.CommUtil.setListViewHeightBasedOnChildren(mDetailsReviewLV, contentItemapter);
    ...
    private void addCommentItem(String content) {
        ...
        com.yuzhi.lixun110ccd.http.HttpClient.get(com.yuzhi.lixun110ccd.http.Caller.DETAILS_ADD_COMMENT, params, new com.yuzhi.lixun110ccd.http.HttpResponseHandler() {
            @Override
            public void onSuccess(com.yuzhi.lixun110ccd.http.RestApiResponse response) {
                String result = response.getResult();
                String message = response.getMessage();
    ...
    private void addFocus() {
        ...
        com.yuzhi.lixun110ccd.http.HttpClient.get(com.yuzhi.lixun110ccd.http.Caller.ADD_FOCUS, params, new com.yuzhi.lixun110ccd.http.HttpResponseHandler() {
            @Override
            public void onSuccess(com.yuzhi.lixun110ccd.http.RestApiResponse response) {
                String result = response.getResult();
                String message = response.getMessage();
...
//                    showToast(message, mContext);
    ...
    private void cancleFocus() {
        ...
        com.yuzhi.lixun110ccd.http.HttpClient.get(com.yuzhi.lixun110ccd.http.Caller.CANCLE_FOCUS, params, new com.yuzhi.lixun110ccd.http.HttpResponseHandler() {
            @Override
            public void onSuccess(com.yuzhi.lixun110ccd.http.RestApiResponse response) {
                String result = response.getResult();
                String message = response.getMessage();
...
//                    showToast(message, mContext);
    ...
    private void focusState() {
        ...
        com.yuzhi.lixun110ccd.http.HttpClient.get(com.yuzhi.lixun110ccd.http.Caller.FOCUS_STATE, params, new com.yuzhi.lixun110ccd.http.HttpResponseHandler() {
            @Override
            public void onSuccess(com.yuzhi.lixun110ccd.http.RestApiResponse response) {
                String result = response.getResult();
                String message = response.getMessage();
    ...
    public void getBottomClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.details_comment:
                mDialog = new com.yuzhi.lixun110ccd.ui.AddContentDialog(mContext, R.style.MessageDialog);
            ...
            case R.id.details_track:
                ...
                switch (flag) {
                    case 0:
                        //我有线索
                        com.yuzhi.lixun110ccd.ui.UIHelper.showMineXS(mContext, publistID);
                        break;
                    case 1:
                        //我要认领
                        com.yuzhi.lixun110ccd.ui.UIHelper.showMineRL(mContext, publistID);
                        break;
                    case 2:
                        //查看线索
                        String publistId = getIntent().getStringExtra("publistID");//发布ID
//                        CommUtil.showToast("publistId--->"+publistId,mContext);
                        com.yuzhi.lixun110ccd.ui.UIHelper.showClueList(mContext, publistId);
                        break;
                    case 3:
                        //我有线索
                        String publistId1 = getIntent().getStringExtra("publistID");//发布ID
                        com.yuzhi.lixun110ccd.ui.UIHelper.showMineXS(mContext, publistId1);
                        break;
                    default:
                        break;
                }
